...
export const PLATFORM_DESCRIPTION = {
  ...
  MISSION:
    "To democratize development by enabling every Sierra Leonean to contribute to national progress through funded community initiatives",
} as const;
...
export const FOCUS_AREA_TAGLINES = {
  AGRICULTURE: {
    ...
    DESCRIPTION:
      "Transforming agriculture through community farming projects and modern techniques",
  },
  ...
  DRUG_ABUSE: {
    ...
    DESCRIPTION:
      "Community-based prevention and rehabilitation programs for drug abuse",
  },
  ...
  YOUTH_EMPOWERMENT: {
    ...
    DESCRIPTION:
      "Skills development and entrepreneurship opportunities for young Sierra Leoneans",
  },
  ...
  HEALTHCARE: {
    ...
    DESCRIPTION:
      "Improving healthcare access and awareness in local communities",
  },
} as const;
...
export const CAMPAIGN_DESCRIPTIONS = {
  KUSH_FREE:
    "Join the movement to create a drug-free future for Sierra Leone's youth",
  GREEN_SALONE:
    "Transforming agriculture for food security and economic growth",
